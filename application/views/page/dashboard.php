	...
	<head>
		...
		<!-- Favicon-->
		<link rel="shortcut icon" href="<?php echo base_url();?>saas/img/fav.png">
		<!-- Author Meta -->
		...
		<link href="https://fonts.googleapis.com/css?family=Poppins:100,200,400,300,500,600,700" rel="stylesheet"> 
			...
			<link rel="stylesheet" href="<?php echo base_url();?>saas/css/animate.min.css">
			...
			<section class="feature-area pb-100" id="service">
				<div class="container">
					<div class="row mockup-container">
						<img class="mx-auto d-block img-fluid" src="<?php echo base_url();?>saas/img/laptop.png" alt="">
					</div>
						...
						<div class="col-lg-6 about-right">
							<div class="active-about-carusel">
								<div class="single-carusel item">
									<img class="img-fluid" src="<?php echo base_url();?>saas/img/about-img.png" alt="">
								</div>
								<div class="single-carusel item">
									<img class="img-fluid" src="<?php echo base_url();?>saas/img/about-img.png" alt="">
								</div>
						...
						<section class="video-area col-lg-6">
							...
							<div class="container">
								<div class="video-content">
									<a href="http://www.youtube.com/watch?v=0O2aH4XLbto" class="play-btn"><img src="<?php echo base_url();?>saas/img/play-btn.png" alt=""></a>
								</div>
							</div>
						</section>											
					</div>
				...
				<div class="container-fluid">
					<div class="row justify-content-center align-items-center">
						<div class="col-lg-8 no-padding about-left relative">
							<div class="overlay overlay-bg"></div>	
							<img class="img-fluid" src="<?php echo base_url();?>saas/img/f2.jpg" alt="">
						</div>
					...
					<div class="row">
						<div class="active-testimonial">
							<div class="single-testimonial item d-flex flex-row">
								<div class="thumb">
									<img class="img-fluid" src="<?php echo base_url();?>saas/img/t1.png" alt="">
								</div>
								<div class="desc">
									<p>
							...
							<div class="single-testimonial item d-flex flex-row">
								<div class="thumb">
									<img class="img-fluid" src="<?php echo base_url();?>saas/img/t2.png" alt="">
								</div>
								<div class="desc">
									<p>
										Accessories Here you can find the best computer accessory for your laptop, monitor, printer, scanner, speaker, projector, hardware.
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-6 single-blog">
							<img class="img-fluid" src="<?php echo base_url();?>saas/img/b1.png" alt="">
							<ul class="tags">
						...
						<div class="col-lg-6 single-blog">
							<img class="img-fluid" src="<?php echo base_url();?>saas/img/b2.png" alt="">
							<ul class="tags">
								<li><a href="#">Travel</a></li>
								<li><a href="#">Life style</a></li>
							</ul>
